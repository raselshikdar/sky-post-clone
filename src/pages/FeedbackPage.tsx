      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
          ...
          <div className="flex gap-3">
            ...
            <Button onPointerDown={(e) => { (e.currentTarget as any).dataset.back = "1"; navigate(-1); }} onClick={(e) => { if ((e.currentTarget as any).dataset.back === "1") return; navigate(-1); }}>Go back</Button>
          </div>
        </div>
      </div>
    );
