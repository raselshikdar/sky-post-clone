    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="sticky top-0 z-10 flex items-center gap-3 border-b border-border bg-background/95 backdrop-blur-sm px-4 py-1.5">
          <button data-back="1" onPointerDown={(e) => { navigate(-1); }} onClick={() => navigate(-1)} className="rounded-full p-1 hover:bg-accent">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
          ...
          <div className="flex gap-3">
            ...
            <Button data-back="1" onPointerDown={(e) => { navigate(-1); }} onClick={() => navigate(-1)}>Go back</Button>
          </div>
        </div>
      </div>
    );
