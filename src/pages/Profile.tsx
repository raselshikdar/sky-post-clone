  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative">
        ...
        <button data-back="1" onPointerDown={(e) => { navigate(-1); }} onClick={() => navigate(-1)} className="absolute left-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-black/50 text-white backdrop-blur-sm hover:bg-black/70">
