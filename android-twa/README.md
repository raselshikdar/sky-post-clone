...
The Android app loads `https://sky-post-clone.lovable.app` in fullscreen using Chrome's Trusted Web Activity. No website files are bundled — the app always loads the live site, so updates appear instantly.
